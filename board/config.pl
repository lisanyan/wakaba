...
# Page look
use constant BOARD_NAME => 'Image Board'; 		# Name of this image board (without directory)
# use constant BOARD_DESC => ''; 		# Board description
use constant TITLE => 'Wakaba'; 				# Name of chan
...
use constant DATE_STYLE => 'phutaba-en'; 		# Date style ('futaba', '2ch', 'localtime', 'tiny')
